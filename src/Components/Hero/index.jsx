...
export const Hero = () => {
    return (<section className={styles.heroContainer}>
                    <div className={styles.heroContent}>
                        ...
                        <p className={styles.herodescription}>Former teacher turned Software Engineer that specialises in fullstack development. Send me a message if you would like to find out more.</p>
