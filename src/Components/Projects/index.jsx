...
export const Projects = () => {
  ...
  return (
    <section className={styles.proContainer}>
      <h2 className={styles.proTitle} id="projects">
        Recent Projects
      </h2>
        ...
        {project.map((projectItem, id) => {
          ...
          return (
            <li key={id} className={styles.projectItem}>
              ...
              <div className={styles.languages} id={styles.tags}>
                {' '}
                {codeLanguage(projectItem)}{' '}
              </div>
              <div>
                <p>
                  <a href={projectItem.demo}>
                    {' '}
                    <button className={projectItem.demoBtn}>Demo</button>{' '}
                  </a>
                  <a href={projectItem.source}>
                    {' '}
                    <button className={projectItem.demoBtn}>Source</button>{' '}
                  </a>
                </p>
              </div>
            </li>
